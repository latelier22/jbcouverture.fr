...
const Navbar = () => {
  ...
  return (
    <nav className="relative flex w-full items-center justify-between bg-red-700 py-2 text-white shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-neutral-600 dark:text-neutral-200 md:flex-wrap md:justify-start" data-te-navbar-ref>
